...
export default function Header() {
  ...
  return (
    <div className='nav fixed top-0 w-full h-24 flex flex-col items-center justify-evenly bg-white z-20 p-2' style={{boxShadow: 'rgba(0,0,0,0.7) 0 0 5px'}} id='container'>
        ...
        <div className='flex justify-center w-full h-12' id='nav'>
            <div className='flex justify-center items-center w-[45rem]'>
                ...
                <div className={`${coquette.className} flex justify-around w-full text-[1.35rem] font-bold text-[#2e2e2e]`} id='nav'>
